...
class ConstraintSolver:
    ...
    def resolve(self):
        _s = self._solver
        _dofs_state = _s.dofs_state
        _entities_info = _s.entities_info
        ...
        if _s._options.noslip_iterations > 0:
            self.noslip()
    ...
    def noslip(self):
        _s = self._solver
        _static_config = _s._static_rigid_sim_config
        if _s._para_level >= gs.PARA_LEVEL.PARTIAL:
